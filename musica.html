...
<head>
    ...
    <title>Agenda de Música - BAMARTE</title>
...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Música -->
        <main class="py-16">
            <div class="text-center mb-12">
                <h1 class="text-4xl md:text-5xl font-black text-orange-500">Agenda de Música</h1>
                <p class="text-lg text-gray-600 mt-2">Todos los conciertos y eventos musicales.</p>
            </div>
    ...
    <script type="module">
        ...
        async function fetchAndDisplayMusicEvents() {
            try {
                ...
                // 1. Filtrar y ordenar con SEGURIDAD EXTREMA
                    ...
                    const eventCard = `
                        <a href="event-detail.html?id=${event.id}" class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col group">
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                <h4 class="text-xl font-bold mb-2 group-hover:text-purple-600 transition-colors">${event.title}</h4>
                                <p class="text-gray-500 text-sm mb-4"><span class="font-semibold">Lugar:</span> ${event.locationName || 'A confirmar'}</p>
                                <p class="text-gray-600 text-sm flex-grow">${(event.description || '').substring(0, 100)}...</p>
                            </div>
                        </a>`;
                ...
                console.error("Error al obtener los eventos de música: ", error);
                loaderContainer.style.display = 'none';
