...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Agenda de Arte -->
        <main class="py-16">
            <section class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-cyan-500">Agenda Completa de Artes Visuales</h2>
                    <p class="text-lg text-gray-600 mt-2">Todos los eventos vigentes de artes visuales, ordenados por fecha.</p>
                </div>
    ...
    <script type="module">
        ...
        // Fetch de TODOS los eventos de Arte
        async function fetchAndDisplayAllArtEvents() {
            try {
                const eventsRef = collection(db, "events");
                // *** CAMBIO PRINCIPAL: Se eliminó where("isFeatured", "==", true) para traer TODOS los eventos ***
                const q = query(
                    eventsRef, 
                ...
                // Lógica de filtrado seguro para mostrar solo eventos vigentes (sin cambios)
                ...
                if (upcomingEvents.length === 0) {
                    eventsContainer.innerHTML = `<p class="col-span-full text-center text-gray-500 font-bold uppercase tracking-widest py-10">No hay eventos de artes visuales en la agenda en este momento.</p>`;
                } else {
                ...
                console.error("Error al obtener los eventos de arte: ", error);
                eventsLoader.style.display = 'none';
                eventsContainer.innerHTML = `<p class="col-span-full text-center text-red-500 p-4 bg-red-100 rounded-lg font-bold">Ocurrió un error al cargar los eventos.</p>`;
            }
        }

        // Ejecutar función
        fetchAndDisplayAllArtEvents();
    </script>
