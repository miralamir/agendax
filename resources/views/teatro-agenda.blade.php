...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Agenda de Teatro -->
        <main class="py-16">
            <section class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-pink-500">Agenda Completa de Teatro</h2>
                    <p class="text-lg text-gray-600 mt-2">Todas las obras y eventos de teatro vigentes, ordenados por fecha.</p>
                </div>
    ...
    <script type="module">
        ...
        async function fetchAndDisplayAllTheaterEvents() {
            try {
                ...
                if (upcomingEvents.length === 0) {
                    eventsContainer.innerHTML = `<p class="col-span-full text-center text-gray-500 font-bold uppercase tracking-widest py-10">No hay eventos de teatro en la agenda en este momento.</p>`;
                } else {
        ...
        fetchAndDisplayAllTheaterEvents();
    </script>
