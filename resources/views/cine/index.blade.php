    ...
    <main>
        ...
        <header class="py-12" style="background-color: var(--color-cine-light); border-bottom: 3px solid var(--color-cine);">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 class="text-4xl font-black" style="color: var(--color-cine);">Cine</h1>
            </div>
        </header>
        ...
        <nav class="bg-white border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-cine); border-color: var(--color-cine); background-color: transparent;">Estrenos</a>
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-cine); border-color: var(--color-cine); background-color: transparent;">Festivales / Ciclos</a>
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-cine); border-color: var(--color-cine); background-color: transparent;">Novedades</a>
                </div>
            </div>
        </nav>
        ...
        <section class="py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="#" class="text-sm font-bold" style="color: var(--color-cine);">Ver todos →</a>
                </div>
