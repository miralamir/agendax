        ...
        <nav class="bg-white border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-musica); border-color: var(--color-musica);">Agenda</a>
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-musica); border-color: var(--color-musica);">Lanzamientos</a>
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-musica); border-color: var(--color-musica);">Festivales</a>
                    <a href="#" class="px-4 py-2 text-sm font-bold rounded-full border" style="color: var(--color-musica); border-color: var(--color-musica);">Novedades</a>
                </div>
            </div>
        </nav>
