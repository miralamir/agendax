...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Agenda de Literatura -->
        <main class="py-16">
            <section class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-emerald-500">Agenda Completa de Literatura</h2>
                    <p class="text-lg text-gray-600 mt-2">Todas los eventos de literatura vigentes, ordenados por fecha.</p>
                </div>
    ...
    <script type="module">
        ...
        function createEventCard(event) {
            ...
            return `
                <a href="event-detail.html?id=${event.id}" class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col group">
                    <div class="relative">
                        <img src="${event.mainImageUrl || 'https://placehold.co/400x250/d1fae5/10b981?text=BAMARTE'}" alt="${event.title}" class="w-full h-56 object-cover" onerror="this.onerror=null;this.src='https://placehold.co/400x250/d1fae5/10b981?text=BAMARTE';">
        ...
        async function fetchAndDisplayAllLiteratureEvents() {
            try {
                ...
                if (upcomingEvents.length === 0) {
                    eventsContainer.innerHTML = `<p class="col-span-full text-center text-gray-500 font-bold uppercase tracking-widest py-10">No hay eventos de literatura en la agenda en este momento.</p>`;
                } else {
        ...
        fetchAndDisplayAllLiteratureEvents();
    </script>
