...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Agenda de Cine -->
        <main class="py-16">
            <section class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-blue-500">Agenda Completa de Cine</h2>
                    <p class="text-lg text-gray-600 mt-2">Todas las películas y eventos de cine vigentes, ordenados por fecha.</p>
                </div>
    ...
    <script type="module">
        ...
        async function fetchAndDisplayAllCinemaEvents() {
            try {
                ...
                if (upcomingEvents.length === 0) {
                    eventsContainer.innerHTML = `<p class="col-span-full text-center text-gray-500 font-bold uppercase tracking-widest py-10">No hay eventos de cine en la agenda en este momento.</p>`;
                } else {
        ...
        fetchAndDisplayAllCinemaEvents();
    </script>
