        ...
        <header class="py-6">
            <nav class="flex justify-between items-center">
                ...
                <ul class="hidden md:flex items-center space-x-8 font-bold text-sm">
                    ...
                    <li><a href="/musica" class="uppercase text-orange-500 hover:opacity-75 transition-opacity duration-300">Música</a></li>
                    <li><a href="/teatro" class="uppercase text-pink-500 hover:opacity-75 transition-opacity duration-300">Teatro</a></li>
                    <li><a href="/cine" class="uppercase text-blue-500 hover:opacity-75 transition-opacity duration-300">Cine</a></li>
                    <li><a href="/literatura" class="uppercase text-emerald-500 hover:opacity-75 transition-opacity duration-300">Literatura</a></li>
                </ul>
