...
<head>
    ...
    <title>Agenda de Cine - BAMARTE</title>
...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Contenido Principal de la Página de Cine -->
        <main class="py-16">
            <div class="text-center mb-12">
                <h1 class="text-4xl md:text-5xl font-black text-blue-500">Agenda de Cine</h1>
                <p class="text-lg text-gray-600 mt-2">Todos los estrenos y festivales de cine.</p>
            </div>
    ...
    <script type="module">
        ...
        async function fetchAndDisplayCineEvents() {
            try {
                ...
                console.error("Error al obtener los eventos de cine: ", error);
                loaderContainer.style.display = 'none';
