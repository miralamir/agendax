...
<head>
    ...
    <title>Novedades de Artes Visuales - BAMARTE</title>
...
<body class="text-gray-800">
    ...
    <div class="container mx-auto px-4">
        ...
        <!-- Header y Navegación (IDÉNTICO A LAS OTRAS PÁGINAS) -->
        <header class="py-6">
        ...
        <main class="py-16">
            <section>
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-cyan-500">Novedades de Artes Visuales</h2>
                    <p class="text-lg text-gray-600 mt-2">Todas las noticias y artículos del mundo de las artes visuales, ordenadas por fecha.</p>
                </div>
    ...
    <script type="module">
        ...
        // Función para crear la tarjeta de Noticias (Estandarizada con arte.html)
        ...
        // Fetch de TODAS las Noticias de Arte
        async function fetchAndDisplayAllArtNews() {
            try {
                ...
                if (querySnapshot.empty) {
                    newsContainer.innerHTML = `<p class="col-span-full text-center text-gray-500 font-bold uppercase tracking-widest py-10">No hay noticias de artes visuales en este momento.</p>`;
                    return;
                }
